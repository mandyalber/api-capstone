...
function displayYoutubeResults(youtubeResponseJson, searchTerm){
    if (youtubeResponseJson.items.length === 0){
        $('.js-youtube-results').append(
            `<p>Sorry, no YouTube videos were found. Please check your spelling and try again.</p>
             <p>Or, you can try browsing <a href="https://www.google.com/search?q=${searchTerm}" target="_blank">Google&rsquo;s search results</a></p><p class="google-search"><img src="images/google-search.jpg" alt="google-search"></p>`
        );
    }
    else {            
        let videos = [];     
